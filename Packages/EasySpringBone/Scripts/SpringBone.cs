...
namespace EasySpringBone
{
    ...
    {
        protected Vector3 STIFFNESS_FACTOR = Vector3.right;
        ...
        protected Vector3 preTip;
        protected Vector3 nowTip;
        ...
        public virtual void init(IQuery _query, float _boneLength)
        {
            this.query = _query;
        ...
        protected virtual Vector3 calcForce()
        {
