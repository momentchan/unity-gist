...
namespace mj.gist.math {
    public static class GaussianDistribution {
        ...
        public static Vector3 GenerateRandomPointStandard() {
            return new Vector3(RandomGenerator.RandGaussian(0, 1f),
                               RandomGenerator.RandGaussian(0, 1f),
                               RandomGenerator.RandGaussian(0, 1f));
        }
        ...
        public static Vector3 GenerateRandomPoint(Matrix4x4 sigma) {
            ...
            var r1 = RandomGenerator.RandGaussian(0f, 1f);
            var r2 = RandomGenerator.RandGaussian(0f, 1f);
            var r3 = RandomGenerator.RandGaussian(0f, 1f);
            var x = c00 * r1;
            var y = c10 * r1 + c11 * r2;
